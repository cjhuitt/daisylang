...
samples: arrays calc classical exceptional fibo hash hello lights mirror printing truthy
...
exceptional: daisy samples/exceptional.daisy
	./daisy samples/exceptional.daisy
