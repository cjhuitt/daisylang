...
Constants["Throwable"].runtime_class.def :message do end

Constants["Numerical"] = DaisyContract.new("Numerical")
RootContext.symbols["Numerical"] = Constants["Numerical"]
Constants["Numerical"].runtime_class.def :+ do end
Constants["Numerical"].runtime_class.def :- do end
Constants["Numerical"].runtime_class.def :* do end
Constants["Numerical"].runtime_class.def :/ do end
Constants["Numerical"].runtime_class.def :^ do end
